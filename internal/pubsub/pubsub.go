...
const (
	Event_EntityAttacked string = "entity_attacked" // entity was attacked by player's attacks
	Event_EntityKilled   string = "entity_killed"   // entity was directly killed by player's attacks
	Event_EntityDied     string = "entity_died"     // entity died (but not by player's hand)
	Event_StartDialog    string = "start_dialog"    // player started dialog
	Event_EndDialog      string = "end_dialog"      // player ended dialog
	Event_GetItem        string = "get_item"        // player gets item
	Event_UseItem        string = "use_item"        // player uses (or equips) an item
